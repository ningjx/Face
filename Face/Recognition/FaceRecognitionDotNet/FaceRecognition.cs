...
namespace FaceRecognitionDotNet
{
    ...
    public sealed class FaceRecognition : DisposableObject
    {
        ...
        /// <summary>
        /// 实例化<see cref="FaceRecognition"/> 使用存储模型文件的目录路径初始化.
        /// </summary>
        /// <param name="directory">存储模型文件的路径。</param>
        /// <exception cref="FileNotFoundException">没有找到模型文件。</exception>
        /// <exception cref="DirectoryNotFoundException">没有找到指定的目录路径。</exception>
        ...
        /// <summary>
        /// 将一个可枚举的人脸编码集合与一个已知的人脸编码集合进行比较，得到一个可枚举的比较人脸欧式距离集合。
        /// </summary>
        ...
        /// <summary>
        /// 返回一个可枚举的人脸特征数据集合，该集合对应于指定图像中的所有人脸。
        /// </summary>
        ...
        /// <summary>
        /// 返回一个可枚举的集合，该集合包含图像中每个人脸的人脸部件位置(眼睛、鼻子等)。
        /// </summary>
        /// <param name="faceImage">图像包含了人脸。图像可以包含多个面孔。</param>
        /// <param name="faceLocations">用于面的位置矩形的可枚举集合。如果指定为空，方法将查找人脸位置。</param>
        /// <param name="model">人脸检测模式。</param>
        /// <returns>脸部部位位置(眼睛、鼻子等)字典的可枚举集合。</returns>
        /// <exception cref="ArgumentNullException"><paramref name="faceImage"/> 空</exception>
        /// <exception cref="ObjectDisposedException"><paramref name="faceImage"/> 这个对象被处理</exception>
        /// <exception cref="NotSupportedException">海伦数据集不存在</exception>
        ...
        /// <summary>
        /// 从 <see cref="double"/> array新建一个<see cref="FaceEncoding"/>
        /// </summary>
        ...
        /// <summary>
        /// 从指定路径（绝对）创建一个<see cref="Image"/>
        /// </summary>
        /// <param name="file">包含要从中创建<see cref="Image"/>的路径的字符串</param>
        /// <param name="mode">图像颜色模式</param>
        /// <returns><see cref="Image"/> 已创建</returns>
        /// <exception cref="FileNotFoundException">指定路径不存在</exception>
